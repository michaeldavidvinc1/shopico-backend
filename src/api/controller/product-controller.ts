...
export class ProductController {
    ...
    static async update(req: Request, res: Response, next: NextFunction) {
        try {
            ...
            request.image = Array.isArray(request.image) ? request.image.concat(imageUrls) : imageUrls;
    ...
    static async activationProduct(req: Request, res: Response, next: NextFunction) {
        try {
            const productSlug = req.params.slug;
